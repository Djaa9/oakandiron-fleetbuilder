...
function Ship(props) {
  ...
  const [commanderSelectionDisabled, setCommanderSelectionDisabled] = useState(
    false
  );
  const [
    upgradeCard1SelectorEnabled,
    setUpgradeCard1SelectorEnabled,
  ] = useState(true);
  const [
    upgradeCard2SelectorEnabled,
    setUpgradeCard2SelectorEnabled,
  ] = useState(true);

  useEffect(() => {
    if (!faction || !ship) return;
    ...
    setSelectedUpgradeCard1(
      ship.upgradeCard1
        ? availableUpgradeCards.find((card) => {
            return card.name === ship.upgradeCard1.name;
          })
        : ""
    );
    ...
    setSelectedUpgradeCard2(
      ship.upgradeCard2
        ? availableUpgradeCards.find((card) => {
            return card.name === ship.upgradeCard2.name;
          })
        : ""
    );
  ...
  const handleUpgradeCard2Change = (newUpgradeCard) => {
    if (newUpgradeCard.name === "onlyAllowedSolo") {
      setUpgradeCard1SelectorEnabled(false);
      setSelectedUpgradeCard2("");
    } else setUpgradeCard1SelectorEnabled(true);
      ...
      <Card className={classes.card}>
        ...
        >
          ...
          >
            ...
            <IconButton
              className={classes.removeShipIcon}
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={isFlagship}
                    onChange={(event) => {
                      handleIsFlagShipChanged(event.target.checked);
                    }}
                  />
                }
                label="Flagship"
              ...
              >
                <FormControl className={classes.formControl}>
                  ...
                  <Select
                    ...
                    value={commander}
                    onChange={(event) =>
                      handleCommanderChanged(event.target.value)
                    }
                  >
                ...
                {commander && (
                  <IconButton
                    ...
                    onClick={() => handleCommanderChanged("")}
                  >
              ...
              >
                <FormControl className={classes.formControl}>
                  ...
                  <Select
                    ...
                    onChange={(event) => {
                      handleSkillLevelChanged(event.target.value);
                    }}
                  >
                ...
                <FormControlLabel
                  ...
                  control={
                    <Checkbox
                      ...
                      onChange={(event) =>
                        handleUpgradeSelectionChanged(event, upgrade)
                      }
                    />
                  }
              ...
              >
                <FormControl className={classes.formControl}>
                  ...
                  <Select
                    ...
                    onChange={(event) =>
                      handleUpgradeCard1Change(event.target.value)
                    }
                  >
                ...
                {selectedUpgradeCard1 && (
                  <IconButton
                    className={classes.removeButtons}
                    onClick={() => setSelectedUpgradeCard1("")}
                  >
                    <CloseIcon fontSize="small" />
                  </IconButton>
                )}
              ...
              >
                <FormControl className={classes.formControl}>
                  ...
                  <Select
                    ...
                    onChange={(event) =>
                      handleUpgradeCard2Change(event.target.value)
                    }
                  >
                ...
                {selectedUpgradeCard2 && (
                  <IconButton
                    className={classes.removeButtons}
                    onClick={() => setSelectedUpgradeCard2("")}
                  >
                    <CloseIcon fontSize="small" />
                  </IconButton>
                )}
